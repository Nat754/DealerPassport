...
class TestSRRPageSmoke:
    ...
    @allure.title('Проверить доступность списка групп отчетов SRR на prod')
    ...
    @allure.title('Проверить формирование отчета SRR в файл excell на prod')
    ...
    @allure.title('Проверить формирование отчета SRR на экране на prod')
    ...
    @allure.title('Проверить текст в модальном окне prod')
